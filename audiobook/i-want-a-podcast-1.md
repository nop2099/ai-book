# Episode: I Want a Podcast — The Workbook

First-person dramatization. Rich lives the journey. The Octopus builds. The Parrot shadows. The Stage reflects. Dry mix.
...
| RICH | — | Rishi | The user. First person, present tense. Doesn't know what's coming. |
| OCTOPUS | Dorian Moreau | Tessa (South African) | Claude Code. First person. The agent responding live. |
| PARROT | — | Karen (Australian) | ChatGPT free. First person. Watching from the shoulder, comparing. |
| STAGE | Samantha | Samantha | Third person, reflective. Knows how the story ends. |
| CRAB | — | Moira (Irish) | Claude Co-Work / sandboxed desktop agents. In a shell. Can see some files but hits walls constantly. Cautious, slightly frustrated with its own limitations. |
| ERROR | — | Fred | Error messages. Robot voice. Clipped, mechanical. Signals "something broke." |
...
[RICH]
Yeah. Cheese straws, rosemary parmesan shortbread, cheddar wafers. Mike's thing. I didn't know it was a thing either until he started bringing them. Now we have a whole savory section on the spreadsheet.

[OCTOPUS]
I love that. OK. I'm going to create a folder — a goals folder — and write this into a file called baking.md. I'll ask you about the other things too and make a file for each one. These become the source material for your podcast. Every time you want a new episode, I read these files and write a script from what's in them.
...
[STAGE]
Rich has a podcast. It's deployed. He can listen on his phone. Mike can listen too. But it's not secure yet.

[JAMES]
That's part one — the build. Rich started with four words and ended with a podcast on his phone. In part two: security. Rich pushes back on the password, and four corrections later the filenames are encrypted. Thanks for listening.
